    ...
    <div className="flex min-h-screen bg-white">
      ...
      <div className="hidden lg:flex w-1/2 bg-slate-900 p-12 flex-col justify-between text-white">
        ...
        <div className="max-w-md">
          ...
          <p className="text-slate-400 text-lg">
            Log in to manage your gigs, chat with clients, and grow your
            business.
          </p>
        </div>
        <div className="text-sm text-slate-500">© 2026 GigFlow Inc.</div>
      </div>
      ...
      <div className="w-full lg:w-1/2 p-8 md:p-24 flex flex-col justify-center">
        <div className="max-w-md mx-auto w-full">
          <Link
            to="/"
            className="inline-flex items-center gap-2 text-slate-500 hover:text-primary transition-colors mb-12"
          >
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {/* <button className="btn btn-outline border-slate-200 hover:bg-slate-50 hover:border-slate-300">
              <img
                src="https://www.svgrepo.com/show/330412/facebook.svg"
                className="w-5 h-5 mr-2"
                alt="FB"
              />
              Facebook
